   ...
   <form action="<c:url value="/report/insertChat"/>" method="post" enctype="multipart/form-data">
   		<div class="container-box">
			<div class="form-group col-12 mt-3">
			   ...
			   <input type="number" class="form-control" id="cr_num" name="cr_num" readonly value="${cr_num}">
			</div>
			<div class="form-group col-12 mt-3">
			   <label for="re_me_id">신고 신정자</label>
			   <input type="text" class="form-control" id="re_me_id" name="re_me_id" readonly value="${user.me_id}">
			</div>
			<div class="form-group select-box col-12 mt-3">
...
<script type="text/javascript">	
	$("form").submit(function() {
		...
		let type = $("[name=re_name]").val();
		if(type == "신고 유형을 선택해주세요."){
			alert("신고 유형을 선택해주세요.");
			$("[name=re_name]").focus();
			return false;
		}
