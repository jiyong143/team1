...
public class PageMaker_report {
	...
	public void calculate() {
		...
		endPage = (int)(Math.ceil(crir.getPage()/(double)displayPageNum)*displayPageNum);
		
		startPage = endPage - displayPageNum + 1;
		//컨텐츠 개수를 이용하여 계산한 최대 페이지 번호 : 14
		int tmpEndPage = (int)(Math.ceil(totalCount/(double)crir.getPerPageNum()));
	...
	public PageMaker_report(int displayPageNum, Criteria_report crir, int totalCount) {
