...
public class PageMaker_member {
	...
	public void calculate() {
		...
		endPage = (int)(Math.ceil(crim.getPage()/(double)displayPageNum)*displayPageNum);
		
		startPage = endPage - displayPageNum + 1;
		//컨텐츠 개수를 이용하여 계산한 최대 페이지 번호 : 14
		int tmpEndPage = (int)(Math.ceil(totalCount/(double)crim.getPerPageNum()));
	...
	public PageMaker_member(int displayPageNum, Criteria_member crim, int totalCount) {
